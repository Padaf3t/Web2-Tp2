...
const GestionnaireProduits = forwardRef((props, ref) => {
    ...
    useImperativeHandle(ref, () => {
        ...
        return {
             ...
             */
            sauvegarderProduit: (event, setMessageErreur, setErreurPresente) => {
                fonctionnaliteProduit.sauvegarderProduit(event, setListeProduits, listeProduits, produitEnModification, setProduitEnModification, setValeurFormulaire, setMessageErreur, setErreurPresente, triggerProduitRefetch,handleBoutonAfficherForm, setError)
            },
            /**
